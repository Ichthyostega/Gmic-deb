...
_gmic()
{
	...
	case "${prev}" in
		...
		;;
		"-warp" | "--warp")
		COMPREPLY=( $(compgen -W "[warping_field],_is_relative={0|1},_interpolation={0|1},_borders,_nb_frames>0 >") )
		return 0
		;;
		"-deriche" | "--deriche")
		...
		;;
		"-convolve" | "--convolve")
		COMPREPLY=( $(compgen -W "[mask],_borders,_is_normalized={0|1} >") )
		return 0
		;;
		"-correlate" | "--correlate")
		COMPREPLY=( $(compgen -W "[mask],_borders,_is_normalized={0|1} >") )
		...
		;;
		"-erode" | "--erode")
		COMPREPLY=( $(compgen -W "size>=0 size_x>=0,size_y>=0,_size_z>=0 [mask],_borders,_is_normalized={0|1}") )
		return 0
		;;
		"-dilate" | "--dilate")
		COMPREPLY=( $(compgen -W "size>=0 size_x>=0,size_y>=0,size_z>=0 [mask],_borders,_is_normalized={0|1}") )
		return 0
		;;
		"-inpaint" | "--inpaint")
		...
		;;
		"-distance" | "--distance")
		COMPREPLY=( $(compgen -W "isovalue[%],_metric isovalue[%],[custom_metric]") )
		return 0
		;;
		"-eikonal" | "--eikonal")
		...
		;;
		"-label" | "--label")
		COMPREPLY=( $(compgen -W "is_high_connectivity={0|1},_tolerance>=0 >") )
		return 0
		;;
		...
		COMPREPLY=( $(compgen -W "z-factor [elevation] \'formula\',_x0,_y0,_x1,y1,_dx[%],_dy[%] (noargs)") )
		return 0
		;;
		"-isoline3d" | "--isoline3d")
		...
		COMPREPLY=( $(compgen -W "_diameter,_density,_offset1,_offset2,_angle,_aliasing,_shading,_opacity,_color,... >") )
		return 0
		;;
		...
		;;
		"-rr2d" | "--rr2d")
		COMPREPLY=( $(compgen -W "width>0,height>0,_mode={0=inside|1=outside|2=padded},0=<_interpolation_type<=6 >") )
		return 0
		;;
		...
		;;
		"-r2dx" | "--r2dx")
		COMPREPLY=( $(compgen -W "width>0,_interpolation_type={0,1,2,3,4,5} >") )
		return 0
		;;
		"-resize2dx" | "--resize2dx")
		COMPREPLY=( $(compgen -W "width>0,_interpolation_type={0,1,2,3,4,5} >") )
		...
		;;
		"-r2dy" | "--r2dy")
		COMPREPLY=( $(compgen -W "height>0,_interpolation_type={0,1,2,3,4,5} >") )
		return 0
		;;
		"-resize2dy" | "--resize2dy")
		COMPREPLY=( $(compgen -W "height>0,_interpolation_type={0,1,2,3,4,5} >") )
		...
		;;
		"-r3dz" | "--r3dz")
		COMPREPLY=( $(compgen -W "depth>0,_interpolation_type={0,1,2,3,4,5} >") )
		return 0
		;;
		"-resize3dz" | "--resize3dz")
		COMPREPLY=( $(compgen -W "depth>0,_interpolation_type={0,1,2,3,4,5} >") )
		...
		COMPREPLY=( $(compgen -W "width,height,_depth,smoothness>=0,_anisotropy=[0,1],sharpening>=0 >") )
		return 0
		;;
		"-expand_x" | "--expand_x")
		COMPREPLY=( $(compgen -W "size_x>=0,_borders={0=dirichlet|1=neumann|2=cyclic} >") )
		return 0
		;;
		"-expand_y" | "--expand_y")
		COMPREPLY=( $(compgen -W "size_y>=0,_borders={0=dirichlet|1=neumann|2=cyclic} >") )
		return 0
		;;
		"-expand_z" | "--expand_z")
		COMPREPLY=( $(compgen -W "size_z>=0,_borders={0=dirichlet|1=neumann|2=cyclic} >") )
		return 0
		;;
		"-expand_xy" | "--expand_xy")
		COMPREPLY=( $(compgen -W "size>=0,_borders={0=dirichlet|1=neumann|2=cyclic} >") )
		return 0
		;;
		...
		;;
		"-Return" | "--Return")
		COMPREPLY=( $(compgen -W "textcontainedinamulti-lineimage. >") )
		return 0
		;;
		...
		;;
		"-marble" | "--marble")
		COMPREPLY=( $(compgen -W "_image_weight,_pattern_weight,_angle,_amplitude,_sharpness>=0,_anisotropy>=0,_alpha=.6,_sigma=1.1,_cut_low>=0,_cut_high>=0 >") )
		return 0
		;;
		"-blur_x" | "--blur_x")
		COMPREPLY=( $(compgen -W "amplitude[%]>=0,_borders={0|1} >") )
		return 0
		;;
		"-blur_y" | "--blur_y")
		COMPREPLY=( $(compgen -W "amplitude[%]>=0,_borders={0|1} >") )
		...
		;;
		"-blur_xy" | "--blur_xy")
		COMPREPLY=( $(compgen -W "amplitude_x[%],amplitude_y[%],_borders={0|1} >") )
		return 0
		;;
		"-blur_xyz" | "--blur_xyz")
		COMPREPLY=( $(compgen -W "amplitude_x[%],amplitude_y[%],amplitude_z,_borders={0|1} >") )
		return 0
		;;
		"-blur_angular" | "--blur_angular")
		COMPREPLY=( $(compgen -W "_amplitude[%],_cx,_cy >") )
		return 0
		;;
		...
		COMPREPLY=( $(compgen -W "_amplitude1[%],_amplitude2[%],_angle=0,_borders={0=dirichlet|1=neumann} >") )
		return 0
		;;
		"-dog" | "--dog")
		...
		;;
		"-pde_flow" | "--pde_flow")
		COMPREPLY=( $(compgen -W "_nb_iter>=0,_dt,_velocity_command,_sequence_flag={0|1} >") )
		return 0
		;;
		"-heat_flow" | "--heat_flow")
		...
		COMPREPLY=( $(compgen -W "amplitude1[%]>=0,_amplitude2[%]>=0,_angle,_nb_iter>=0,_dt>=0,_regul>=0,_regul_type={0=Tikhonov|1=meancurv.|2=TV} >") )
		return 0
		;;
		"-unsharp" | "--unsharp")
		COMPREPLY=( $(compgen -W "_radius[%]>=0,_amount>=0,_threshold[%]>=0 >") )
		return 0
		;;
		...
		;;
		"-map_tones" | "--map_tones")
		COMPREPLY=( $(compgen -W "_threshold>=0,_gamma>=0,_smoothness>=0,iter>=0 >") )
		return 0
		;;
		"-bandpass" | "--bandpass")
		...
		COMPREPLY=( $(compgen -W "_text,_size>0 >") )
		return 0
		;;
		...
		;;
		"-array" | "--array")
		COMPREPLY=( $(compgen -W "_M>0,_N>0,_expand_type={0,1,2} >") )
		return 0
		;;
		"-array_fade" | "--array_fade")
		COMPREPLY=( $(compgen -W "_M>0,_N>0,0<=_fade_start<=100,0<=_fade_end<=100,_expand_type={0,1,2} >") )
		return 0
		;;
		"-array_mirror" | "--array_mirror")
		COMPREPLY=( $(compgen -W "_N>=0,_dir={0,1,2},_expand_type={0|1} >") )
		return 0
		;;
		"-array_random" | "--array_random")
		COMPREPLY=( $(compgen -W "_Ms>0,_Ns>0,_Md>0,_Nd>0 >") )
		return 0
		;;
		"-array_pattern" | "--array_pattern")
		COMPREPLY=( $(compgen -W "_M>0,_N>0,_density>=0,_angle>=0,_zoom>=0,_opacity,_expand_type={0,1,2} >") )
		return 0
		;;
		"-taquin" | "--taquin")
		...
		;;
		"-frame" | "--frame")
		COMPREPLY=( $(compgen -W "_size_x[%]>=0,_size_y[%]>=0,_col1,...,_colN >") )
		return 0
		;;
		"-frame_fuzzy" | "--frame_fuzzy")
		COMPREPLY=( $(compgen -W "_size_x>=0,_size_y>=0,_fuzzyness>=0,_smoothness>=0,_R,_G,_B,_A >") )
		return 0
		;;
		...
		COMPREPLY=( $(compgen -W "_M>=3,_pattern={0=firstimage|1=self},_constrain_size={0|1} >") )
		return 0
		;;
		"-rotate_tiles" | "--rotate_tiles")
		COMPREPLY=( $(compgen -W "_angle,_M>0,N>0 >") )
		return 0
		;;
		"-shift_tiles" | "--shift_tiles")
		COMPREPLY=( $(compgen -W "_M>0,_N>0,_amplitude >") )
		return 0
		;;
		...
		COMPREPLY=( $(compgen -W "_amplitude>=0,_sampling>=0,_opacity,0<=_edge_threshold<=100 >") )
		return 0
		;;
		"-sketchbw" | "--sketchbw")
		...
		COMPREPLY=( $(compgen -W "_cx,_cy,_n>0,_borders={0=dirichlet|1=neumann|2=cyclic} >") )
		return 0
		;;
		...
		COMPREPLY=( $(compgen -W "_x-angle,_y-angle,_zoom>0,_x-center,_y-center,_borders={0=dirichlet|1=neumann|2=cyclic} >") )
		return 0
		;;
		"-water" | "--water")
		...
		;;
		"-twirl" | "--twirl")
		COMPREPLY=( $(compgen -W "_amplitude,_cx,_cy,_borders={0=dirichlet|1=neumann|2=cyclic} >") )
		return 0
		;;
		...
		;;
		"-flower" | "--flower")
		COMPREPLY=( $(compgen -W "_amplitude,_frequency,_offset_r[%],_angle,_cx,_cy,_borders={0=dirichlet|1=neumann|2=cyclic} >") )
		return 0
		;;
		"-zoom" | "--zoom")
		COMPREPLY=( $(compgen -W "_factor,_cx,_cy,_cz,_borders={0=dirichlet|1=neumann|2=cyclic} >") )
		return 0
		;;
		"-deform" | "--deform")
		COMPREPLY=( $(compgen -W "_amplitude>=0 >") )
		...
		COMPREPLY=( $(compgen -W "\"expr_radius\",_\"expr_angle\",_x_center,_y_center,_borders={0|1} >") )
		return 0
		;;
		"-kaleidoscope" | "--kaleidoscope")
		COMPREPLY=( $(compgen -W "_cx,_cy,_radius,_angle,_borders={0=dirichlet|1=neumann|2=cyclic} >") )
		return 0
		;;
		"-rotoidoscope" | "--rotoidoscope")
		COMPREPLY=( $(compgen -W "_cx,_cy,_tiles>0,_smoothness[%]>=0,_borders={0=dirichlet|1=neumann|2=cyclic} >") )
		return 0
		;;
		"-spread" | "--spread")
		...
		COMPREPLY=( $(compgen -W "_frequency>=0,_direction={0|1},_darkness>=0,_lightness>=0 >") )
		return 0
		;;
		"-stripes_y" | "--stripes_y")
		...
		COMPREPLY=( $(compgen -W "\"command\",_channels={All,RGBA,RGB,Y,CbCr,Cb,Cr,L,ab,a,b,H,S,V,K,A,ch,c,h},_normalize={0=cut|1=normalize} >") )
		return 0
		;;
		...
		COMPREPLY=( $(compgen -W "_tolerance[%]>=0,col1,..,colN >") )
		return 0
		;;
		"-replace_color" | "--replace_color")
		COMPREPLY=( $(compgen -W "_tolerance[%]>=0,_smoothness[%]>=0,src1,...,srcN,dest1,...,destN >") )
		return 0
		;;
		"-fc" | "--fc")
		...
		;;
		"-gpt" | "--gpt")
		COMPREPLY=( $(compgen -W "_scorefile,_title,_photo_width>0 >") )
		return 0
		;;
	esac
