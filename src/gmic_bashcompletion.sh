...
_gmic()
{
	...
	case "${prev}" in
		...
		;;
		"-j" | "--j")
		COMPREPLY=( $(compgen -W "eq.to\'-image. >") )
		return 0
		;;
		"-+3d" | "--+3d")
		COMPREPLY=( $(compgen -W "tx,_ty,_tz [object3d] (noargs)") )
