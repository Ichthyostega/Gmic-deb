...
{ 
	...
	opts="\
	      ...
	      *3d -*3d --*3d +*3d\
	      ...
	      fontchart -fontchart --fontchart +fontchart\
	      fps -fps --fps +fps\
	      gcd -gcd --gcd +gcd\
	      hex -hex --hex +hex\
	...
	case "${prev}" in
		...
		;;
		"skeleton" | "-skeleton" | "--skeleton" | "+skeleton")
		COMPREPLY=( $(compgen -W "_boundary_conditions={_0=dirichlet_|_1=neumann_} >") )
		return 0
		;;
		"slic" | "-slic" | "--slic" | "+slic")
		...
		;;
		"animate" | "-animate" | "--animate" | "+animate")
		COMPREPLY=( $(compgen -W "filter_name,"param1_start,...,paramN_start","param1_end,...,paramN_end",nb_frames>=0,_output_frames={_0_|_1_},_output_filename delay>0,_back_and_forth={_0_|_1_}") )
		return 0
		;;
		"apply_camera" | "-apply_camera" | "--apply_camera" | "+apply_camera")
		...
		;;
		"base642img" | "-base642img" | "--base642img" | "+base642img")
		COMPREPLY=( $(compgen -W ""base64_string" >") )
		return 0
		;;
		"base642uchar" | "-base642uchar" | "--base642uchar" | "+base642uchar")
		COMPREPLY=( $(compgen -W ""base64_string" >") )
		...
		;;
		"uchar2base64" | "-uchar2base64" | "--uchar2base64" | "+uchar2base64")
		COMPREPLY=( $(compgen -W "_encoding={_0=base64_|_1=base64url_} >") )
		return 0
		;;
		"img2base64" | "-img2base64" | "--img2base64" | "+img2base64")
		COMPREPLY=( $(compgen -W "_encoding={_0=base64_|_1=base64url_} >") )
